...
<header class="header">
    ...
    <nav class="navbar">
        ...
        <a href="#emergency-leave">emergency leave</a>
    </nav>
...
<section class="home" id="home">
    ...
    <div class="content">
        ...
        <a href="#appointment" class="btn"> Thank you for being a doctor of health+ <span class="fas fa-chevron-right"></span> </a>
    </div>
...
<marquee behavior="scroll" direction="left" style="font-size:20px; color:red;">
                        If you need anything then, please call us at this hotline number: <b>01878789989</b>
                        </marquee>
...
<section class="footer">
    ...
    <div class="box-container">
        ...
        <div class="box">
            ...
            <a href="#appointment"> <i class="fas fa-chevron-right"></i> Emergency leave </a>
